...
router.get('/orders/inCustomer/:customer_id', ShoppingCartController.getCustomerOrders);
router.get('/orders/:order_id', ShoppingCartController.getOrderSummary);
router.get('/orders/shortDetails/:order_id', ShoppingCartController.getOrderShortDetails);
